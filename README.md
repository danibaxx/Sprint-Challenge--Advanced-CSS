...
3. What does `font-size: 62.5%` in the `html` tag do for us when using `rem` units?
    - Helps set the root font to typical web browser default font of 10px, then setting your font-size to 1.8 rems makes it easy to mathematically convert from rems to pixels. 1.8 rems = 18px.

4. How would you describe preprocessing to someone new to CSS?
    - Very interesting and useful. Also, a great way to collaboratively work on a project with multiple people on certain aspects of the project, your compiler will compile all work with no git issues between multiple collaborators. Making collaborations easier with less issues.
